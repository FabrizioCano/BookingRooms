            ...
            {!isAuthenticated ? (
              ...
              <>
                <List>
                  ...
                  <ListItem><Link onClick={handleMobileLinkClick} href="/profile" className="text-lg text-link text-link-hover"><Typography color="blue-gray" className="mr-auto font-normal text-lg"><FaChalkboardTeacher className='inline mr-3' />Profile</Typography></Link></ListItem>
