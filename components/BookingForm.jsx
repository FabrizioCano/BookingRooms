        ...
        <div className="w-full max-w-lg"> 
          ...
          <form className="mt-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="check_in_date" className="block text-sm font-medium text-primary">
                  Check-In Date
                </label>
              ...
              <div>
                <label htmlFor="check_in_time" className="block text-sm font-medium text-primary">
                  Check-In Time
                </label>
              ...
              <div>
                <label htmlFor="check_out_date" className="block text-sm font-medium text-primary">
                  Check-Out Date
                </label>
              ...
              <div>
                <label htmlFor="check_out_time" className="block text-sm font-medium text-primary">
                  Check-Out Time
                </label>
            ...
            <div className="mt-6 flex justify-center">
              <button type="submit" className="px-4 py-2 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 rounded-md w-40">
                Book Room
              </button>
            </div>
          </form>
